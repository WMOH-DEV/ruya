...
@section('content')
    <div class="container-fluid">
        ...
        <div class="content-header">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">قائمة المُعلمين</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">الرئيسية</li>
                        <li class="breadcrumb-item">المُعلمين</li>
                        <li class="breadcrumb-item active">قائمة المُعلمين</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
                            ...
                            @foreach($teachers as $teacher)
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle flex" >
                                        <a href="{{url('teachers/show')}}/{{$teacher->id}}" target="_blank" style="text-decoration: none;">
                                        <button class="btn btn-primary py-1 px-2" data-toggle="tooltip" data-placement="top" title="مشاهدة الملف الشخصي">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                        </a>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-exclamation-triangle"></i> تحذير.. إيقاف مُعلم</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form action="{{url('admincp/teachers/suspend')}}" method="post">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <input type="text" hidden value="{{$teacher->id}}" name="teacher_id">

                                                            <p>هل أنت متأكد من إيقاف المعلم ؟</p>
                                                            <div class="col-12">
                                                                @if($errors->any())
                                                                    <span class="alert"> حدث خطأ <i class="fa fa-times"></i></span>
                                                                @endif
                                                            </div>
