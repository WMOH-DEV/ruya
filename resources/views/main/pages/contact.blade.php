            ...
            @endif
                ...
                <div class="col-xl-6 col-lg-6 offset-lg-3 offset-xl-3">
                    <div class="section-title text-center mb-60">
                        <span><i class="fal fa-ellipsis-h"></i> إبقى دائما على إتصال <i class="fal fa-ellipsis-h"></i></span>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="contact-form-area">
                        <form action="{{url('pages/contact/send')}}" class="subscribe contact-post-form contact-form" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="input-text">
                                        <input class="form-control" type="text" placeholder="الإسم كامل" name="fullName" required>
                                    </div>
                                </div>
                                <div class="col-xl-4">
