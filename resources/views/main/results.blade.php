...
@section('content')
    ...
    <div class="teacher-container px-5  md:px-14 pt-20 min-h-screen flex flex-col justify-between">
        ...
        <!-- content -->
            <form class="grid grid-cols-1 md:grid-cols-4 gap-4 mx-auto md:px-5 mt-5 " method="get"
                  action="{{route('search')}}">
                <label>
                        ...
                        <li class="teacher mt-10 px-5 bg-white shadow-md grid grid-cols-5 gap-4 py-8">
                            ...
                            <div class="info lg:col-span-3 col-span-5 bg-white text-center">
                                ...
                                <div class="pref mt-3">
                                    ...
                                    <div
                                        class="grade_exp flex flex-col md:flex-row pt-5 md:mt-3 items-start md:items-center md:justify-around lg:justify-between">
                                        <!-- Teacher Graduation -->
