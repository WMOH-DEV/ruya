...
<head>
    ...
    <meta name="description"
          content="هنا وصف الموقع">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://linkhere">
    <meta property="og:title" content="Free Bootstrap Template re-coded by WMOH">
    <meta property="og:description"
          content="وصف الموقع هنا">
    <meta property="og:image" content="https://image-link-here">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://linkhere">
    <meta property="twitter:title" content="Free Bootstrap Template re-coded by WMOH">
    <meta property="twitter:description"
          content="هنا وصف الموقع">
    <meta property="twitter:image" content="https://image-link-here">
...
<body class="bg-gray-50">
    ...
    <nav
        class="navbar-top  shadow-sm lg:shadow-none bg-white lg:bg-transparent fixed w-full md:flex md:justify-between md:items-center px-2 lg:px-10 md:py-2">
        ...
        <div class="px-4 py-2 text-sm md:text-sm lg:text-base hidden md:flex md:p-0 nav-links">
            ...
            <a href="{{route('search')}}" class="block text-blue-500 px-2 py-2 mt-1 md:mt-0 md:mr-1 rounded hover:text-blue-600 ">العثور على
                مُعلم</a>
            <a href="{{url('faq')}}" class="block text-blue-500 px-2 py-2 mt-1 md:mt-0 md:mr-1 rounded hover:text-blue-600  ">أسئلة
                شائعة</a>
        </div>
        <div class="px-4 py-2 text-sm md:text-sm lg:text-base  hidden md:flex md:p-0 nav-links">
            @guest()
                <a href="{{route('login')}}"
                   class="block text-blue-500 md:text-white md:bg-blue-500 md:rounded-full md:px-4  px-2 py-2 mt-1 md:mt-0 md:mr-1 rounded hover:bg-blue-600">
            ...
            @endguest
            @auth
                <span class="mx-1 inline-block px-0 lg:px-3 py-2 flex items-center justify-start lg:justify-between">
