...
<div class="teacher-container px-5  md:px-10  pt-16 lg:pt-32 min-h-screen flex flex-col justify-between">
    ...
    <div class="page-body">
        ...
        <!-- content -->
        <form class="grid grid-cols-1 md:grid-cols-4 gap-4 mx-auto px-5 mt-0 md:mt-10 " method="get" action="{{route('search')}}">
            <label>
                ...
                <li class="teacher mt-10 px-2 md:px-5 bg-white shadow-md grid grid-cols-5 gap-2 lg:gap-4 py-4 lg:py-8">
                    ...
                    <div class="info lg:col-span-3 col-span-5 bg-white text-center">
                        ...
                        <div class="pref mt-3">
                            ...
                            <div class="grade_exp flex flex-col md:flex-row pt-10 md:mt-3 md:items-center md:justify-around lg:justify-between">
                                <!-- Teacher Graduation -->
