...
@section('content')
    ...
    <div class="teacher-container px-5  md:px-10  md:px-14 pt-16 lg:pt-32 min-h-screen flex flex-col justify-between">
        ...
        <!-- content -->
            <form class="grid grid-cols-1 md:grid-cols-4 gap-4 mx-auto px-5 mt-0 md:mt-10 " method="get"
                  action="{{route('search')}}">
                <label>
                    <select style="background-color:#fff;"
                            ...
                            dir="rtl" name="stage">
                        <option style="color:rgb(59 59 59)" value disabled selected>اختر المرحلة ...</option>
            ...
            <div class="results-body flex flex-col justify-between">
                ...
                <!-- Search results  -->
                <ul class="search-result px-5 mt-1">

                    @foreach($teachers as $teacher)
                        <li class="teacher mt-10 px-2 md:px-5 bg-white shadow-md grid grid-cols-5 gap-2 lg:gap-4 py-4 lg:py-8">
                            <div
                                class="logo bg-white col-span-1 col-start-3 lg:col-start-1 row-span-2 md:row-span-1 flex items-center justify-center">
                                <img src="{{ asset('uploads') }}/{{$teacher->profile_img}}" alt="pic" class="h-20 lg:h-32"></div>
                                    ...
                                    <div
                                        ...
                                        <div class="grade flex items-center">
                                            ...
                                            @if($teacher->other_subjects)
                                                <p class="mx-1 lg:mx-2">{{$teacher->other_subjects}}</p>
                                            @endif
                                        </div>
                                        <!-- Teacher Experience -->
                                        <div class="exp flex">
