...
@section('content')
    ...
    <div class="h-screen main-site">
        ...
        <div class="form-container flex items-center h-full items-center h-1/2 justify-center">
            ...
            <div class="home-body flex flex-col items-center w-full mb-20 pb-10">
              {{--  <!-- For New users --> --}}
                ...
                <form action="{{route('results')}}" method="get"
                      class="flex flex-col xl:flex-row lg:pr-20 w-full px-10 xl:relative ">

                    <label for="subject" class="lg:w-1/3 xl:w-1/4">
                        <input type="text" name="subject" placeholder="إكتب اسم المادة هنا.."
                               class="focus:outline-none focus:border-gray-100 hover:text-gray-700 border hover:border-gray-200 w-full shadow-inner border-gray-50 rounded-full py-3 px-6">
                    </label>

                    <label for="stage" class="lg:w-1/3 xl:absolute xl:w-40 right-1/4 ">
                        <select name="stage" id="stage"
                                class="my-3 px-4 py-3 xl:my-0 border text-gray-300 shadow-inner focus:outline-none  appearance-none hover:text-gray-600 hover:border-gray-200 rounded-full  w-full">
                    ...
                    <button type="submit"
                            class=" lg:w-1/3 xl:w-1/12 xl:mr-32 sbg-color text-white pr-3 pl-5 py-2 focus:outline-none xl:mr-2 rounded-full shadow-md flex hover:bg-yellow-700 items-center justify-center text-lg">
