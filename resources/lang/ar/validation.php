...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'subject' => [
            'required'		=> 'حقل المادة مطلوب',
            'regex'		 	=>'حقل المادة فارغ أو به رموز غير مسموح بها'
        ],
        'stage' => [
            'required' 		=> 'إختيار المرحلة مطلوب',
            'exit:'			=>'هذه المرحلة غير مسجلة لدينا'
        ],
        'pphour' => [
            'required'		=> 'إختيار ثمن الساعة مطلوب',
            'regex'			=>'حقل السعر خالي او غير صحيح'
        ],
        'hours' => [
            'required' 		=> 'إختيار عدد الساعات مطلوب',
        ],
        'start_date'		=> [
            'date' 			=> 'حقل التاريخ غير صحيح',
        ],
        'contact_way' 		=> [
            'regex' 		=> 'وسيلة التواصل غير صالحة',
        ],
        'teacher__id' 		=> [
            'integer' 		=> 'يوجد خطأ في اختيار المعلم، يرجى تحديث الصفحة',
            'required' 		=> 'يوجد خطأ في اختيار المعلم، يرجى تحديث الصفحة'
        ],
        'student__id' 		=> [
            'integer' 		=> 'يوجد خطأ في تقديم الطلب ، يرجى تحديث الصفحة',
            'required' 		=> 'يوجد خطأ في تقديم الطلب، يرجى تحديث الصفحة'
        ],
        'stage__id' 	=> [
            'integer' 		=> 'يوجد خطأ في اختيار المرحلة',
            'required' 		=> 'يوجد خطأ في تقديم الطلب، يرجى تحديث الصفحة',
            'exists' 		=> 'يوجد خطأ في اختيار المرحلة '
        ],
        'notes' => [
            'max' 			=> 'تم تخطي عدد الحروف المسموح بها',
            'regex' 		=> 'حقل الملاحظات فارغ او تم استخدام رموز غير مسموح بها',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
		...
		'residence_id'			=> 'دولة الإقامة',
		'country_id'			=> 'الجنسية',
		'attachment'			=> 'شهادة المؤهل',
		'brief'			        => 'نبذه مختصرة',
    ],
